...
export const metadata: Metadata = {
  ...
  description:
    "Articles on shipping peak-quality software, scaling teams, and delivering measurable product outcomes across Sri Lanka.",
  alternates: {
    canonical: "/blog",
  },
};
      ...
      <Section padding="lg" className="pt-24 sm:pt-28">
        <div className="space-y-6">
          ...
          <p className="max-w-3xl text-lg text-[var(--color-muted-foreground)]">
            Deep dives into process, performance, and product leadership from the Sri Lankan tech ecosystem. We ship in public so
