...
export const metadata: Metadata = {
  ...
  description:
    "Explore how Apex Nova Labs approaches delivery. Full case studies are coming soon - reach out and we'll walk you through relevant projects.",
  alternates: {
    canonical: "/work",
  },
};
        ...
        {hasCaseStudies ? (
          <div className="space-y-10">
            <SectionHeading
              ...
              description="Each story includes the challenge, the approach, and the measurable results delivered by the Apex Nova Labs pod."
            />
